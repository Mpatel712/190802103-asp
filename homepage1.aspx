<%@ Page Title="" Language="C#" MasterPageFile="~/clientMasterPage.master" AutoEventWireup="true" CodeFile="homepage1.aspx.cs" Inherits="_Default" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="slider_image full text_align_center">
                                                <img class="img-responsive" src="src1/images/burger_slide.png" alt="#" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="src1/images/rs1.png" alt="#" />
                    </div>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="src1/images/rs2.png" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>Noodles</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="src1/images/rs3.png" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>Egg</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="src1/images/rs4.png" alt="#" />
                    </div>
                    <div class="product_blog_cont">
                        <h3>Sushi Dizzy</h3>
                ...
                <div class="item">
                    <div class="product_blog_img">
                        <img src="src1/images/rs5.png" alt="#" />
                    </div>
                    <div class="product_blog_cont">
...
<div class="about">
    <div class="container">
      <div class="row">
         <div class="col-md-12">
             <div class="title">
                <i><img src="src1/images/title.png" alt="#"/></i>
       ...
       <div class="row">
         <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
          ...
          <div class="col-xl-5 col-lg-5 col-md-10 col-sm-12 about_img_boxpdnt">
             <div class="about_img">
                 <figure><img src="src1/images/about-img.jpg" alt="#/"></figure>
             </div>
         </div>      
       </div> 
    </div>
      ...
      <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="src1/images/blog_img1.png" alt="#"/>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mar_bottom">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="src1/images/blog_img2.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Egg & Tosh</h3>
       ...
       <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
        <div class="blog_box">
          <div class="blog_img_box">
            <figure><img src="src1/images/blog_img3.png" alt="#"/>
             <span>02 FEB 2019</span>
            </figure>
          </div>
          <h3>Pizza</h3>
    ...
    <div class="row">
      <div class="col-md-6 offset-md-3">
         <div class="Client_box">
           <img src="src1/images/client.jpg" alt="#"/>
           <h3>Roock Due</h3>
           <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don’t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn’t anything embarrassing hidden in the middle of text.</p>
           <i><img src="src1/images/client_icon.png" alt="#"/></i>
         </div>
      </div>
    </div>
  </div>
