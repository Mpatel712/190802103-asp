...
<body>
        <div class="reg-w3">
            <div class="w3layouts-main">
                ...
                <asp:TextBox ID="TextBox1" runat="server" class="ggg" placeholder="NAME" required=""></asp:TextBox>

               <%-- <input type="email" class="ggg" name="Email" placeholder="E-MAIL" required="">--%>
                <asp:TextBox ID="TextBox2" runat="server" class="ggg"  placeholder="EMAIL" required=""></asp:TextBox>

                <%--<input type="text" class="ggg" name="Phone" placeholder="PHONE" required="">--%>
               

                <%--<input type="password" class="ggg" name="Password" placeholder="PASSWORD" required="">--%>
                <asp:TextBox ID="TextBox4" runat="server" class="ggg" placeholder="PASSWORD" required=""></asp:TextBox>
